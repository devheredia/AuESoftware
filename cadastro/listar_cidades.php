...
$query_usuarios = "SELECT
                    ...
                    LEFT JOIN
                        ...
                        WHERE
                        CONCAT_WS(' ', c.cidade, c.insersor, u.usuario_nome) LIKE '%$termo%'
                        ORDER BY
                            c.cidade $direcao
                    LIMIT
...
while ($row = $resultado_usuarios->fetch_assoc()) {
    $registro = array();
    $registro[] = $row['identificadorCidade'];
    $registro[] = $row['cidade'];
